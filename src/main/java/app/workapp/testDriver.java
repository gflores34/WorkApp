...
public class testDriver {
    public static void main(String[] args) throws SQLException {
        ...
        partsDatabase partsTest = new partsDatabase("commonParts");

        partsTest.createTable("eax2500");
        //test.createTable("calls");


        //partsTest.insertRow("eax2500","102661", "EAX-2500 Board", "Circuit board replacement for an EAX-2500");
        //partsTest.insertRow("eax2500","102660", "EAX-2500 cam assembly", "Cam assembly for an EAX-2500");
